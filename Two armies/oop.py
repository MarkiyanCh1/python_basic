import random
from unit_names import warrior_names

"""
Character characteristics:
Strength - Affects the damage of melee weapons
Dexterity - Affects both ranged weapon damage and melee weapon damage. Whoever has more dexterity will attack first.
Intelligence - Affects the damage of magic weapons, as well as to a small extent the damage of melee weapons 
and the damage of ranged weapons
Focus - Affects only the effectiveness of staves of priests
Constitution- Affects the number of health points of the character
